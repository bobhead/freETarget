...
namespace freETarget.targets {
    ...
    class NRA_A26 : aTarget {
        ...
        private const double zoomStep = 0.45;
        private const decimal pdfZoomFactor = 0.29m;

        private const decimal innerRing = 9.9822m; //mm
        private const decimal ring10 = 19.9898m; //mm
        private const decimal ring9 = 39.9796m; //mm
        private const decimal ring8 = 59.9694m; //mm
        private const decimal ring7 = 79.9592m; //mm
        private const decimal ring6 = 99.9744m; //mm
        private const decimal ring5 = 119.9642m; //mm
        private const decimal outterRing = 139.954m; //mm

        private const int blackRings = 6;  // Largest Black Ring
        private const decimal blackCircle = 108.458m; //mm
        ...
        public NRA_A26(decimal caliber) : base(caliber) {
        ...
        public override string getName() {
            return typeof(NRA_A26).FullName;
        }
