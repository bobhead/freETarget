...
namespace freETarget.targets {
    ...
    class NRA_A32 : aTarget {
        ...
        private const double zoomStep = 0.62;
        private const decimal pdfZoomFactor = 0.29m;

        private const decimal innerRing = 5.537m; //mm
        private const decimal ring10 = 11.151m; //mm
        private const decimal ring9 = 30.150m; //mm
        private const decimal ring8 = 47.600m; //mm
        private const decimal ring7 = 59.309m; //mm
        private const decimal outterRing = 72.009m; //mm

        private const int blackRings = 8;  // Largest Black Ring
        private const decimal blackCircle = 47.600m; //mm
        private const int firstRing = 6;  // Largest Ring

        private decimal innerTenRadius;
        private decimal r10, r9, r8, r7, r6;

        private static readonly decimal[] rings = new decimal[] { outterRing, ring7, ring8, ring9, ring10, innerRing };


        public NRA_A32(decimal caliber) : base(caliber) {
        ...
        public override string getName() {
            return typeof(NRA_A32).FullName;
        }
