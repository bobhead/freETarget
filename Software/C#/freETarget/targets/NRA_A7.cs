...
namespace freETarget.targets {
    ...
    class NRA_A7 : aTarget {
        ...
        private const double zoomStep = 0.72;
        private const decimal pdfZoomFactor = 0.29m;

        private const decimal ring10 = 8.509m; //mm
        private const decimal ring9 = 21.209m; //mm
        private const decimal ring8 = 33.909m; //mm
        private const decimal ring7 = 46.609m; //mm
        private const decimal ring6 = 59.309m; //mm
        private const decimal outterRing = 72.009m; //mm

        private const int blackRings = 7;  // Largest Black Ring
        private const decimal blackCircle = 46.609m; //mm
        ...
        public NRA_A7(decimal caliber) : base(caliber) {
