/* NRA A-37 Mini Palma 800 yd reduced for 100 yard */
...
namespace freETarget.targets {
    ...
    class NRA_A37 : aTarget {
        ...
        private const double zoomStep = 0.28;
        private const decimal pdfZoomFactor = 0.29m;

        private const decimal innerRing = 25.4m; //mm
        private const decimal ring10 = 50.8m; //mm
        private const decimal ring9 = 73.66m; //mm
        private const decimal ring8 = 99.06m; //mm
        private const decimal ring7 = 124.46m; //mm
        private const decimal ring6 = 147.32m; //mm
        private const decimal outterRing = 172.72m; //mm
        ...
        public NRA_A37(decimal caliber) : base(caliber) {
        ...
        public override string getName() {
            return typeof(NRA_A37).FullName;
        }
