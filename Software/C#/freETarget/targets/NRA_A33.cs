/* NRA A-33 300 meter ISSF target reduced for 100 yards */
...
namespace freETarget.targets {
    ...
    class NRA_A33 : aTarget {
        ...
        private const decimal innerRing = 11.303m; //mm
        private const decimal ring10 = 26.543m; //mm
        private const decimal ring9 = 57.023m; //mm
        private const decimal ring8 = 87.503m; //mm
        private const decimal ring7 = 117.983m; //mm
        private const decimal ring6 = 148.463m; //mm
        private const decimal ring5 = 178.943m; //mm
        private const decimal ring4 = 209.423m; //mm
        private const decimal ring3 = 239.903m; //mm
        private const decimal ring2 = 270.383m; //mm
        private const decimal outterRing = 300.863m; //mm
        ...
        public NRA_A33(decimal caliber) : base(caliber) {
        ...
        public override string getName() {
            return typeof(NRA_A33).FullName;
        }
