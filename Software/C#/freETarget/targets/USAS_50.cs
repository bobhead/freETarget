/* USAS-50 50 meter international reduced for 50 ft */
...
namespace freETarget.targets {
    ...
    class USAS_50 : aTarget {
        ...
        private const decimal ring10 = 0.760m; //mm
        private const decimal ring9 = 4.120m; //mm
        private const decimal ring8 = 9.000m; //mm
        private const decimal ring7 = 13.870m; //mm
        private const decimal ring6 = 18.750m; //mm
        private const decimal ring5 = 23.630m; //mm
        private const decimal ring4 = 28.500m; //mm
        private const decimal outterRing = 33.380m; //mm

        private const int blackRings = 3;  // Largest Black Ring
        private const decimal blackCircle = 33.380m; //mm
        private const int firstRing = 3;  // Largest Ring

        private decimal innerTenRadius;
        private decimal r10, r9, r8, r7, r6, r5, r4, r3;

        private static readonly decimal[] rings = new decimal[] { outterRing, ring4, ring5, ring6, ring7, ring8, ring9, ring10 };


        public USAS_50(decimal caliber) : base(caliber) {
            ...
            r3 = outterRing / 2m + pelletCaliber / 2m;
        }
        ...
        public override string getName() {
            return typeof(USAS_50).FullName;
        }
