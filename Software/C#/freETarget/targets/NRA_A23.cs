...
namespace freETarget.targets {
    ...
    class NRA_A23 : aTarget {
        ...
        private const double zoomStep = 0.43;
        private const decimal pdfZoomFactor = 0.29m;

        private const decimal innerRing = 9.906m; //mm
        private const decimal ring10 = 22.606m; //mm
        private const decimal ring9 = 48.006m; //mm
        private const decimal ring8 = 73.406m; //mm
        private const decimal ring7 = 98.806m; //mm
        private const decimal ring6 = 124.206m; //mm
        private const decimal outterRing = 149.606m; //mm
        ...
        public NRA_A23(decimal caliber) : base(caliber) {
        ...
        public override string getName() {
            return typeof(NRA_A23).FullName;
        }
