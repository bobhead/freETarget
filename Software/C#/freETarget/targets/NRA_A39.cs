/* NRA A-39 Mini Palma 1000 yd reduced for 100 yard */
...
namespace freETarget.targets {
    ...
    class NRA_A39 : aTarget {
        ...
        private const double zoomStep = 0.34;
        private const decimal pdfZoomFactor = 0.29m;

        private const decimal innerRing = 20.32m; //mm
        private const decimal ring10 = 40.64m; //mm
        private const decimal ring9 = 58.42m; //mm
        private const decimal ring8 = 78.74m; //mm
        private const decimal ring7 = 96.52m; //mm
        private const decimal ring6 = 116.84m; //mm
        private const decimal outterRing = 137.16m; //mm
        ...
        public NRA_A39(decimal caliber) : base(caliber) {
        ...
        public override string getName() {
            return typeof(NRA_A39).FullName;
        }
