...
namespace freETarget.targets {
    ...
    class NRA_A21 : aTarget {
        ...
        private const decimal innerRing = 50.8m; //mm
        private const decimal ring10 = 101.6m; //mm
        private const decimal ring9 = 203.2m; //mm
        private const decimal ring8 = 304.8m; //mm
        private const decimal ring7 = 406.4m; //mm
        private const decimal outterRing = 508m; //mm

        private const int blackRings = 8;  // Largest Black Ring
        private const decimal blackCircle = 304.8m; //mm
        ...
        public NRA_A21(decimal caliber) : base(caliber) {
        ...
        public override string getName() {
            return typeof(NRA_A21).FullName;
        }
