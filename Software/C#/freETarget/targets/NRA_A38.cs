/* NRA A-38 Mini Palma 900 yd reduced for 100 yard */
...
namespace freETarget.targets {
    ...
    class NRA_A38 : aTarget {
        ...
        private const double zoomStep = 0.31;
        private const decimal pdfZoomFactor = 0.29m;

        private const decimal innerRing = 22.86m; //mm
        private const decimal ring10 = 45.72m; //mm
        private const decimal ring9 = 66.04m; //mm
        private const decimal ring8 = 86.36m; //mm
        private const decimal ring7 = 109.22m; //mm
        private const decimal ring6 = 129.54m; //mm
        private const decimal outterRing = 152.4m; //mm
        ...
        public NRA_A38(decimal caliber) : base(caliber) {
        ...
        public override string getName() {
            return typeof(NRA_A38).FullName;
        }
